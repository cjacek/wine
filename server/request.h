...
C_ASSERT( FIELD_OFFSET(struct create_window_request, client_ptr) == 48 );
...
C_ASSERT( FIELD_OFFSET(struct alloc_user_handle_request, client_ptr) == 16 );
C_ASSERT( FIELD_OFFSET(struct alloc_user_handle_request, type) == 24 );
C_ASSERT( sizeof(struct alloc_user_handle_request) == 32 );
...
C_ASSERT( FIELD_OFFSET(struct free_user_handle_request, type) == 16 );
C_ASSERT( sizeof(struct free_user_handle_request) == 24 );
C_ASSERT( FIELD_OFFSET(struct free_user_handle_reply, client_ptr) == 8 );
C_ASSERT( sizeof(struct free_user_handle_reply) == 16 );
